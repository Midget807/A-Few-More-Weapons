...
public class ModItems {
    ...
    public static final Item GOLDEN_HALBERD = registerItem("golden_halberd", new HalberdItem(ToolMaterials.GOLD, 6, -3.0f, new FabricItemSettings().maxCount(1)));
    ...
    public static final Item IRON_LANCE = registerItem("iron_lance", new LanceItem(ToolMaterials.IRON, 3, -3.2f, new FabricItemSettings().maxCount(1)));
    public static final Item GOLDEN_LANCE = registerItem("golden_lance", new LanceItem(ToolMaterials.GOLD, 3, -3.2f, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_LANCE = registerItem("diamond_lance", new LanceItem(ToolMaterials.DIAMOND, 3, -3.2f, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_LANCE = registerItem("netherite_lance", new LanceItem(ToolMaterials.NETHERITE, 3, -3.2f, new FabricItemSettings().maxCount(1)));
    public static final Item WOODEN_CLAYMORE = registerItem("wooden_claymore", new ClaymoreItem(ToolMaterials.WOOD, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    public static final Item STONE_CLAYMORE = registerItem("stone_claymore", new ClaymoreItem(ToolMaterials.STONE, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    public static final Item IRON_CLAYMORE = registerItem("iron_claymore", new ClaymoreItem(ToolMaterials.IRON, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    public static final Item GOLDEN_CLAYMORE = registerItem("golden_claymore", new ClaymoreItem(ToolMaterials.GOLD, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    public static final Item DIAMOND_CLAYMORE = registerItem("diamond_claymore", new ClaymoreItem(ToolMaterials.DIAMOND, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    public static final Item NETHERITE_CLAYMORE = registerItem("netherite_claymore", new ClaymoreItem(ToolMaterials.NETHERITE, 1, -2.8f, new FabricItemSettings().maxCount(1)));
    ...
    public static final Item NETHERITE_HORSE_ARMOR = registerItem("netherite_horse_armor", new HorseArmorItem(13, "netherite", new FabricItemSettings().maxCount(1).fireproof()));
