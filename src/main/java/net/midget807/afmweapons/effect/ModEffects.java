...
import net.midget807.afmweapons.effect.afmw_effect.EmptyEffect;
import net.midget807.afmweapons.effect.afmw_effect.SizzlingEffect;
...
public class ModEffects {
    public static final StatusEffect CONCUSSED = registerEffect("concussed", new EmptyEffect(StatusEffectCategory.HARMFUL, 2039587)); //TODO update colour
